...
description: "Deep RL, policy gradients, and sim-to-real transfer for robot learning"
...
**Objective:** Find policy π that maximizes expected return:
...
## 7. Case Study: Bipedal Walking with RL
...
- ✅ MDP formulation and value functions
